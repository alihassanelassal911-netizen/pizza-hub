    ...
    if question:
        ...
        with st.chat_message('ai'):
            with st.spinner('Generating..✨'):
                ...
                and a cool dude and please put emojes when
                talking and say i got you bro
                ...
                If the question is not related to PizzaHub answer it then say, politely that you
